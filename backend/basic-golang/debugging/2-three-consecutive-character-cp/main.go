...
func main() {
	/*
		...
		helloworld -> -1
	*/
	result := ThreeConsecutiveCharacterPosition("www.ruangguru.com")
	fmt.Println(result)

	resultCorrect := ThreeConsecutiveCharacterPositionCorrect("www.ruangguru.com")
	fmt.Println(resultCorrect)
}
